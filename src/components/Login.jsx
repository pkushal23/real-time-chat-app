    ...
    <section className='flex flex-col justify-center items-center h-[100vh]'>
            <div className='bg-white shadow-lg p-5 rounded-x1 h-[27rem] w-[20rem] flex flex-col justify-center items-center'>
                ...
                <div className='w-full'>
                    <input name= "email" onChange= {handleChangeUserData}type='email' className='border border-green-200 w-full p-2 rounded-md bg-[#01aa851d] text-[#004939f3] mb-3 font-medium outline-none placeholder:text-[#00493958]' placeholder='Email'></input>
                    <input name="password" onChange={handleChangeUserData}type='password' className='border border-green-200 w-full p-2 rounded-md bg-[#01aa851d] text-[#004939f3] mb-3 font-medium outline-none placeholder:text-[#00493958]' placeholder='Password'></input>
                </div>
                <div className='w-full'>
